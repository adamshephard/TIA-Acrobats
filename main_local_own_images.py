...
class ACROBATICS(object):
    ...
    def __init__(self, input_registration_info="/data/ACROBAT/data/test_images/registration_table.csv",
                       image_folder="/data/ACROBAT/data/test_images/images",#'/input/images/',
                       anno_folder="/data/ACROBAT/data/test_images/annos/",#'/input/images/',
                       output_folder="/data/ACROBAT/output/test_images/",#'/output/'):
                       resolution=1.25):
    ...
    def process(self):
        ...
        for _, info in info_df.iterrows():
            ...
            output_dir = os.path.join(self.output_folder, info['output_dir_name'])   
